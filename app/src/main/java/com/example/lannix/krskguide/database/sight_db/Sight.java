...
import static com.example.lannix.krskguide.database.sight_db.DBSightsOpenHelper.NUM_COLUMN_ADDRESS;
import static com.example.lannix.krskguide.database.sight_db.DBSightsOpenHelper.NUM_COLUMN_COORDINATE_LATITUDE;
import static com.example.lannix.krskguide.database.sight_db.DBSightsOpenHelper.NUM_COLUMN_COORDINATE_LONGITUDE;
import static com.example.lannix.krskguide.database.sight_db.DBSightsOpenHelper.NUM_COLUMN_DESCRIPTION_IMAGES;
import static com.example.lannix.krskguide.database.sight_db.DBSightsOpenHelper.NUM_COLUMN_DESCRIPTION_TEXT;
import static com.example.lannix.krskguide.database.sight_db.DBSightsOpenHelper.NUM_COLUMN_ID;
import static com.example.lannix.krskguide.database.sight_db.DBSightsOpenHelper.NUM_COLUMN_MAP_IMAGE_ID;
import static com.example.lannix.krskguide.database.sight_db.DBSightsOpenHelper.NUM_COLUMN_NAME;
