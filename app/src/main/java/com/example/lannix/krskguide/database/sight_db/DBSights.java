...
public class DBSights {
    ...
    public void addStuffData() {
        ...
        images.clear();
        images.add(R.drawable.stolbi);
        insert(new Sight(0, 55.969844, 92.786493, "Столбы",
                R.drawable.stolbi_round, images, "Красноярские Столбы - уникальное явление." +
        ...
        images.clear();
        images.add(R.drawable.pozdeev);
        insert(new Sight(0, 56.01140000,  92.86084100, "Памятник Андрею Поздееву",
                R.drawable.posdeev_round, images, "На проспекте Мира, в историческом " +
        ...
        images.clear();
        images.add(R.drawable.chasovnya);
        insert(new Sight(0, 56.023547, 92.859975, "Часовня Параскевы Пятницы",
                R.drawable.charge_round, images, "Часо́вня Параске́вы Пя́тницы — православная часовня, " +
